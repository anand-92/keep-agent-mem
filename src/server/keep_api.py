...
def get_client():
    ...
    if not email or not master_token:
        raise ValueError(
            "Missing Google Keep credentials. Please set GOOGLE_EMAIL and GOOGLE_MASTER_TOKEN environment variables."
        )
...
def serialize_note(note, detail_level="full"):
    ...
    Args:
        ...
        detail_level: One of 'metadata', 'summary', or 'full'
    ...
    payload["collaborators"] = [
        serialize_collaborator(collaborator) for collaborator in note.collaborators.all()
    ]
